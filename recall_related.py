...
def add_similar_ids_under_name(name_instance_dict, id_name_dict):
    ...
    for (author_name, name_instance) in name_instance_dict.items():
    ...
    count = 0
    for (author_name1, name_instance1) in name_instance_dict.items():
    ...
    count = 0
    for (author_id, author_name_list) in id_name_dict.items():
